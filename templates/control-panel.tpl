...
{block name="subcontent"}
	...
	<div class="container">
		<p>To enable CanvasHack in the new UI, click the button below to download the <code>canvashack-loader.js</code> file which you will upload in the Theme Editor.</p>
		...
		<p>&hellip;and the following URL into your Global CSS URL:</p>
		<p class="text-center"><code><a href="{$appURL}/canvashack.css.php">{$appURL}/canvashack.css.php</a></code></p>
	</div>
